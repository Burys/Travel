...
import com.cobblers.mapper.InsuranceMapper;
...
//        return insuranceMapper.selectCountByExample(whereArgs("deleteStatus", "0"));
        var example = new Example(Insurance.class);
        example.createCriteria()
                .andEqualTo("deleteStatus",0);
        return insuranceMapper.selectCountByExample(example);
    }
...
//        return insuranceMapper.selectOneByExample(whereArgs("deleteStatus", "0", "id", id));
        ...
        example.createCriteria()
                .andEqualTo("deleteStatus",0)
                .andEqualTo("id",id);
        return insuranceMapper.selectOneByExample(example);
    }
